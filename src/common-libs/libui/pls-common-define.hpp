...
constexpr auto CONFIGS_GCC_PATH = "SPECTRUMLiveStudio/user/gcc.json";
constexpr auto CONFIGS_USER_CONFIG_PATH = "SPECTRUMLiveStudio/user/cache";
constexpr auto CONFIGS_CAM_USER_CONFIG_PATH = "PRISMLens/user/cache";
constexpr auto CONFIGS_USER_THUMBNAIL_PATH = "SPECTRUMLiveStudio/user/prismThumbnail.png";
constexpr auto CONFIGS_USER_TEXTMOTION_PATH = "SPECTRUMLiveStudio/textmotion/%1";
constexpr auto CONFIGS_CATEGORYS_PATH = "SPECTRUMLiveStudio/user/categorys.json";
constexpr auto CONFIGS_CATEGORYS_LIBRARY_PATH = "SPECTRUMLiveStudio/user/library.json";
constexpr auto CONFIGS_RESOLUTIONGUIDE_PATH = "SPECTRUMLiveStudio/library/Library_Policy_PC/ResolutionGuide.json";
constexpr auto CONFIGS_GPOP_PATH = "SPECTRUMLiveStudio/user/gpop.json";
constexpr auto CONFIGS_BEATURY_USER_PATH = "SPECTRUMLiveStudio/beauty/";
...
constexpr auto CONFIGS_BEATURY_DEFAULT_IMAGE_PATH = "SPECTRUMLiveStudio/beauty/image/";
constexpr auto BEAUTY_CONFIG = "BeautyConfig";
constexpr auto GIPHY_STICKERS_CONFIG = "GiphyStickersConfig";
constexpr auto GIPHY_STICKERS_USER_PATH = "SPECTRUMLiveStudio/sticker/";
constexpr auto GIPHY_STICKERS_CACHE_PATH = "SPECTRUMLiveStudio/sticker/cache/";
constexpr auto GIPHY_STICKERS_JSON_FILE = "SPECTRUMLiveStudio/sticker/sticker.json";
constexpr auto CONFIGS_VIRTUAL_CAMERA_PATH = "SPECTRUMLiveStudio/user/prism-virtualcam.txt";
constexpr auto CONFIGS_LIBRARY_POLICY_PATH = "SPECTRUMLiveStudio/library/Library_Policy_PC/";
constexpr auto CONFIGS_LIBRARY_POLICY_LISCENSE_PATH = "license";

constexpr auto PRISM_STICKER_USER_PATH = "SPECTRUMLiveStudio/prism_sticker/";
constexpr auto PRISM_STICKER_CACHE_PATH = "SPECTRUMLiveStudio/prism_sticker/cache/";
constexpr auto PRISM_STICKER_JSON_FILE = "SPECTRUMLiveStudio/reaction/reaction.json";
constexpr auto PRISM_STICKER_DOWNLOAD_CACHE_FILE = "SPECTRUMLiveStudio/prism_sticker/download_cache.json";
constexpr auto PRISM_STICKER_RECENT_JSON_FILE = "SPECTRUMLiveStudio/prism_sticker/recent_used.json";
...
constexpr auto SENSETIME_UNZIP_PATH = "SPECTRUMLiveStudio/beauty";
constexpr auto SENSETIME_ZIP = "SPECTRUMLiveStudio/beauty/library_SenseTime_PC.zip";
constexpr auto SENSETIME_FILE_PATH = "SPECTRUMLiveStudio/beauty/library_SenseTime_PC/";
constexpr auto SENSETIME_NEW_VERSION_FILE_PATH = "SPECTRUMLiveStudio/beauty/library_SenseTime_PC/2.5.0/";
...
constexpr auto CONFIGS_MUSIC_USER_PATH = "SPECTRUMLiveStudio/music/";
...
constexpr auto SCENE_TEMPLATE_DIR = "SPECTRUMLiveStudio/scene-templates/";
constexpr auto SCENE_TEMPLATE_JSON = "SPECTRUMLiveStudio/scene-templates/SceneTemplates.json";
...
constexpr auto CONFIGS_COLOR_FILTER_USER_PATH = "SPECTRUMLiveStudio/color_filter/";
...
constexpr auto PRISM_CRASH_CONFIG_PATH = "SPECTRUMLiveStudio/crashDump/crash.json";
