if(SPARKLE_APPCAST_URL AND SPARKLE_PUBLIC_KEY)
  ...
  target_sources(spectrum-studio PRIVATE update/mac-update.cpp update/mac-update.hpp update/sparkle-updater.mm)
  set_source_files_properties(update/sparkle-updater.mm PROPERTIES COMPILE_FLAGS -fobjc-arc)

  target_link_libraries(spectrum-studio PRIVATE "$<LINK_LIBRARY:FRAMEWORK,${SPARKLE}>")
  ...
  target_enable_feature(spectrum-studio "Sparkle updater" ENABLE_SPARKLE_UPDATER)

  include(cmake/feature-macos-update.cmake)
else()
  set(SPARKLE_UPDATE_INTERVAL 0) # Set anything that's not an empty integer
  target_disable_feature(spectrum-studio "Sparkle updater")
endif()
