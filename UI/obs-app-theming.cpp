...
void OBSApp::FindThemes()
{
	...
	{
		const std::string themeDir = App()->userConfigLocation.u8string() + "/spectrum-studio/themes";
...
bool OBSApp::SetTheme(const QString &name)
{
	...
	string filename("spectrum-studio/themes/");
...
bool OBSApp::InitTheme()
{
	...
	char userDir[512];
	if (GetAppConfigPath(userDir, sizeof(userDir), "spectrum-studio/themes")) {
